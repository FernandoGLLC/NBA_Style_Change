--- 
title: "NBA PlayStyle Evolution Project"
author: "Fernando Garcia De Llano, Abhay Kothari, Jash Desai, Jay Maniyar, Arsh Gulati"
date: "`r Sys.Date()`"
...
![](https://lh7-us.googleusercontent.com/9zcUjGg4-fVJPvADaGlrdV3B0MQ-U7te_-CXoSLQC2AMmYnHwvrwheFIT4HPgE_FftOXMIJBOJCTaNB_ocM06vxbmj6yr-U55rWDkT5D3EnM6JVzL6OYyVRKhQeh1IM4lX94YjrjZ6nARF9n6xzMMv4)
...
![](https://lh7-us.googleusercontent.com/VmhN6yigvox5PHHkGmR_bgm-NObY08Axn5fPOcNHt9_8SZBeCsrRzuCwybSKvC1IklKNYXW0w8eL_fOAIYN-yqeUX-WJGVT35oPfior9LUYQyzz4pUuA83bF6Spbbv_UMg4DmY2pdLyPHyG8xH-P-y0)
...
![](https://lh7-us.googleusercontent.com/JlvDP8smsJV755ruLSf-VcgJkkPfn97M8LZDrDxO1WsP4L0_i2W9NwBsbJh2pKHl8S1lmRuruT1ZtxMvFcXyOjjT_iazsqKLLSIJjaoVDqlFJ0Y_CL-X5_umdZHruaXZEkM5v62lW2KbYzxQQgdTsvU)

~**(Figure 2)**~

![](images/StephCurry_3PM_Graph-01.png)

~**(Figure 3)**~

![](images/Percentages_Graph-01.png)

~**(Figure 4)**~

![](images/FTA_FTM_Graph.png)

~**(Figure 5)**~

![](images/FTPercentage_Graph.png)

~**(Figure 6)**~

### K-Means Cluster Analysis & Dimensionality Reduction
...
For Decade 1 (2000-2009), PC1 revealed substantial loading on offensive metrics (e.g., FG, PTS, 2P, FT), as outlined in Table 3. PC2 highlighted significant loading on rebounding, defensive metrics, and shooting percentages (e.g., ORB, TRB, BLK, FG%), also outlined in Table 3.

![](images/PCALoadingsD1.png){width="307"}

~PCA Loadings - Decade 1, **Table 3**~

![](images/PCALoadingsD2.png){width="307"}
...
![](images/PCAVarianceD1-02.png)

~PC Variance - Decade 1, **Table 5**~

![](images/PCAVarianceD2.png)
...
![](images/Elbow_Plot_Decade1.png){width="591"}

![](images/Silhouette_Plot_Decade1.png){width="591"}

~Elbow and Silhouette Plots - Decade 1, **Figure 7**~

![](images/Elbow_Plot_Decade2.png){width="591"}

![](images/Silhouette_Plot_Decade2.png){width="591"}

~Elbow and Silhouette Plots - Decade 2, **Figure 8**~

To visualize the 4 clusters per decade, scatter plots were generated, aligning with the PCA results. Each plot graphed NBA players against 2 principal components, and categorized them into 4 different clusters. Generally, PC1 exhibited more loading on offensive statistics (FGA, 3PA, 2PA), while PC2 emphasized rebounding and defensive statistics (TRB, BLK, FG%). The details of these plots provide a good understanding of the play style clusters across the two decades.

![](images/Cluster_Analysis_Scatter_Plot_Decade1.png)

~Cluster Scatter Plot - Decade 1, **Figure 9**~

![](images/Cluster_Analysis_Scatter_Plot_Decade2-01.png)
...
![](https://lh7-us.googleusercontent.com/JrUbAv_h7ma7oHBc1QjKH9RReWDYyQA4dyfS1zLNEWIhLWmEIsl2z7vgBtAVFIoJj9xcI9c0MQByD_ZgLsCWEJbuZtVgb8rDzFiyjo36wczoeECgC4cSMaeGZcRk5W8sqqD2UBCnEksTqhRh4BR_q5Y)

~Cluster Averages Table - Decade 1, **Table 7**~

[The Bench Warmer (Cluster 0)]{.underline}

-   Players in Cluster 0 provide moderate scoring (4.56 PTS) and lack defensive prowess, coming in last for STL and BLK.

[The Best Player (Cluster 1)]{.underline}
...
[Sharpshooter (Cluster 2)]{.underline}
...
![](images/clipboard-3331446244.png)

~Cluster Averages Table - Decade 2, **Table 8**~

[The Best Player (Cluster 0)]{.underline}
...
[The Bench Warmer (Cluster 1)]{.underline}
...
In general, roles in the NBA have remained consistent across both Decade 1 and Decade 2, featuring distinct clusters like Lead Scorer, Big Man, and Sharpshooter. However, players are showcasing versatility beyond traditional positions. In Decade 2, the 'Big Man' cluster stands out with higher averages in assists (AST), 3PA, and a 4% increase in 3P% compared to Decade 1. The 'Sharpshooter' cluster in Decade 2 exhibits higher total rebounds (TRB) and blocks (BLK) averages. Across all clusters, there's a noticeable increase in average 3PA. These observations suggest a shift in traditional role responsibilities and skill sets.
...
[**A few notable findings emerge from our analysis:**]{.underline}

1.  General roles in the NBA, such as Lead Scorer, Big Man, and Sharp Shooter, have not changed.

2.  Traditional positional distinctions have blurred, with players becoming more versatile across roles.

3.  Players have gotten better. Their shot-making ability has significantly improved, as suggested by the 2P%, 3P%, and FG% increase over both decades.

4.  The significance of 3-point shooting has grown, with all related 3-point statistics showing a notable increase across all positions.

5.  The decline in personal fouls indicates a shift towards a less physical style of play.

6.  The decline in Free Throw Attempts aligns with the reduction in personal fouls, highlighting the ever-changing scoring dynamics.
...
Dutta, P. (2021, August 26). How data analytics is changing the sport of Basketball & the NBA. Medium. [https://medium.com/\@pratyushdutta29/how-data-analytics-is-changing-the-sport-of-basketball-the-nba-f85aa31e9ebb](https://medium.com/@pratyushdutta29/how-data-analytics-is-changing-the-sport-of-basketball-the-nba-f85aa31e9ebb) 
